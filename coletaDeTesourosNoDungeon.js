...
const totalSalas = 3; //foi comentado esta parte para poder rodar teste parseInt(gets());
...
//os print foram reemplazados pelo console.log para melhor visualização no ambiente de testes
    if (  temTesouro) {
